...
//
// There is no aim-down-sights slot here. Ghostrunner's player carries a katana,
// a shuriken and the abilities on the skill wheel, and none of them raises a
// sight: the pawn has no zoom state, the crosshair is drawn at the hip for the
// whole of a level, and the field-of-view changes it does have (a slide, a
// dash, the rift) are speed effects the zoom compensation already answers.
namespace gr_ht {
