@echo off
:: ============================================
:: Ghostrunner Head Tracking - Uninstall
:: ============================================
...
::
:: Empty: this mod has shipped no release yet, so there is no older filename.
set "LEGACY_DLLS="
...
:: DLLs were deployed.
set "MOD_LEFTOVERS=HeadTracking.ini GhostrunnerHeadTracking.log GhostrunnerHeadTracking.prev.log"
