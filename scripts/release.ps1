...
<#
.SYNOPSIS
    Cuts a release of Ghostrunner Head Tracking: stamp version, changelog, package,
    commit, tag, push.
...
try {
    ...
    Update-VersionInFile -Path 'CMakeLists.txt' -Pattern 'project\(GhostrunnerHeadTracking VERSION [0-9.]+' -Replacement "project(GhostrunnerHeadTracking VERSION $new"
