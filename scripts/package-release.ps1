...
<#
.SYNOPSIS
    Packages the release ZIP for Ghostrunner Head Tracking.
...
$modName = 'GhostrunnerHeadTracking'
...
$stage = Join-Path $env:TEMP "ghostrunner-ht-stage-$([Guid]::NewGuid().ToString('N'))"
