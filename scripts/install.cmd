@echo off
:: ============================================
:: Ghostrunner Head Tracking - Install
:: ============================================
...
:: --- CONFIG BLOCK ---
set "GAME_ID=ghostrunner"
set "MOD_DISPLAY_NAME=Ghostrunner Head Tracking"
set "MOD_DLLS=GhostrunnerHeadTracking.asi"
set "MOD_INTERNAL_NAME=GhostrunnerHeadTracking"
set "MOD_VERSION=0.0.0"
set "STATE_FILE=.headtracking-state.json"
set "FRAMEWORK_TYPE=ASILoader"
:: Filename the ASI loader DLL is renamed to: the import the game exe already
:: has. Ghostrunner-Win64-Shipping.exe imports WINMM.dll statically and does not
:: import dinput8.dll.
...
::
:: Empty here: games.json resolves the exe to Ghostrunner\Binaries\Win64\, so the
:: body already deploys into that folder rather than the install root. The
:: Ghostrunner.exe in the install root is a launcher and loads nothing.
set "ASI_SUBDIR="
