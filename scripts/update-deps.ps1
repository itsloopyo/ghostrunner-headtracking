...
try {
    ...
    $readme = @(
        ...
        '`winmm.dll` beside the game exe (`Ghostrunner/Binaries/Win64/`) as the ASI hook slot:',
        '`Ghostrunner-Win64-Shipping.exe` imports WINMM.dll statically and does not import',
