...
//
// The rects are the ones Ghostrunner produced on a 5120x1440 monitor with a 48 px
...
using gr_ht::window_placement::Decide;
using gr_ht::window_placement::Placement;
